...
export default function Header() {
  ...
  return (
    <>
      <div className="flex w-full justify-center my-6 sticky top-6 z-20">
        <div
          ref={navContainerRef}
            ...
            <NavLink
              ...
              className={({ isActive, isPending }) =>
                clsx(
                  ...
                  !isActive &&
                    !isPending &&
                    'font-normal dark:text-white/70 dark:hover:text-white before:content-[attr(data-text)] before:block before:font-semibold before:invisible before:h-0'
                )
              }
            >
              {/* Actual visible text */}
